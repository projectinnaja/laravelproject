        ...
        <section className="relative flex items-center justify-center min-h-[80vh] bg-gradient-to-b from-red-50 to-white overflow-hidden">
            ...
            <div className="relative text-center max-w-3xl mx-auto px-6">
                ...
                <p className="mt-6 text-lg text-gray-600">
                    Temukan berbagai proyek mahasiswa Telkom University dari
                    desain, aplikasi, hingga penelitian yang menginspirasi.
                    Dibuat untuk berbagi, belajar, dan memberi inspirasi bagi
                    semua.
                </p>
                <div className="mt-8">
                    <a
