        ...
        <div>
            <div className="max-w-6xl px-4 sm:px-6 py-7 lg:px-8 mx-auto">
                <div className="flex flex-wrap gap-5">
                    ...
                    <div style={{flex: '1'}}>
                        <div className="flex flex-wrap gap-5">
                            <FooterCard title="Mudah" text="Dalam Transaksi dan Pembayaran"/>
                            <FooterCard title="Mudah" text="Dalam Transaksi dan Pembayaran"/>
                            <FooterCard title="Mudah" text="Dalam Transaksi dan Pembayaran"/>
                            <FooterCard title="Mudah" text="Dalam Transaksi dan Pembayaran"/>
                        </div>
    ...
    return (
        <div className="bg-[#b01116]">
            <div className="max-w-6xl px-4 sm:px-6 py-7 lg:px-8 mx-auto">
                <div className="flex flex-wrap gap-5">
                    <div style={{flex: '1'}}>
                        <h3 className="font-semibold text-[1.2rem] text-[#fbfbfb]">Pusat Informasi</h3>
                    ...
                    <div style={{flex: '1'}}>
                        <div className="flex flex-wrap gap-5">
                            <div className="flex flex-1">
                                <h3 className="font-semibold text-[1.2rem] text-[#fbfbfb]">Metode Pembayaran</h3>
                            </div>
                            <div className="flex flex-1">
                                <h3 className="font-semibold text-[1.2rem] text-[#fbfbfb]">Jasa Pengiriman</h3>
                            </div>
