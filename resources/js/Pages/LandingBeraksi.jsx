...
export default function LandingBeraksi() {
    const parentStyle = {
        ...
        paddingBottom: document.querySelector("#footerBeraksi")?.offsetHeight + 'px'
    }
    return (
        <div id='superParent' style={parentStyle} className='min-h-full relative'>
            ...
            <HeaderBeraksi id="headerBeraksi">
                <div className="flex justify-between min-h-[80px]">
                        ...
                        <div className="flex items-center">
                            <Link href={route('login')} className='flex items-center gap-2 text-[#6d7684] font-semibold bg-[#eeefef] px-4 py-1 text-sm rounded-md'>Login <LogIn className='w-4'></LogIn></Link>
                        </div>
                    </div>
            </HeaderBeraksi>
            <main>
